...
def inject_css():
    # Detect theme from user preference
    theme = "dark"
    try:
...
<style>
    ...
    h2, h3, h4 { color: #1e293b !important; letter-spacing: -0.01em; }
    ...
    .kpi-label { color: #64748b; font-size: 0.72rem; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 4px; }
    .kpi-val { font-size: 1.35rem; font-weight: 700; }
    .green { color: #059669; } .red { color: #dc2626; } .white { color: #1e293b; } .blue { color: #6366f1; }
    ...
    .cat-row:hover { background: rgba(255, 255, 255, 0.95); }
    .cat-header { display: flex; justify-content: space-between; font-size: 0.82rem; margin-bottom: 4px; }
    .cat-name { color: #1e293b; font-weight: 500; }
    .cat-amount { color: #6366f1; font-weight: 600; }
    .cat-track { background: rgba(0,0,0,0.06); border-radius: 6px; height: 6px; overflow: hidden; }
    .cat-fill { height: 100%; border-radius: 6px; transition: width 0.5s ease; }
    ...
    .txn-left { display: flex; align-items: center; gap: 0.55rem; }
    .txn-icon { font-size: 1.1rem; }
    .txn-ens { color: #1e293b; font-weight: 500; font-size: 0.84rem; }
    .txn-cat { color: #64748b; font-size: 0.68rem; }
    .txn-amt { font-weight: 700; font-size: 0.88rem; white-space: nowrap; }
    .txn-added { color: #6366f1; font-size: 0.62rem; font-style: italic; }
    ...
    .user-card:hover { background: rgba(255, 255, 255, 0.95); }
    .user-info { display: flex; align-items: center; gap: 0.6rem; }
    .user-avatar { font-size: 1.4rem; }
    .user-name { color: #1e293b; font-weight: 600; font-size: 0.88rem; }
    .user-handle { color: #64748b; font-size: 0.72rem; }
    .user-badge {
        display: inline-block; padding: 0.15rem 0.5rem; border-radius: 10px;
        font-size: 0.7rem; font-weight: 500;
    }
    .badge-pending { background: rgba(251, 191, 36, 0.15); color: #d97706; }
    .badge-friend { background: rgba(16, 185, 129, 0.15); color: #059669; }
    ...
    .topbar-user {
        display: flex; align-items: center; gap: 0.5rem;
        color: #1e293b; font-weight: 500; font-size: 0.9rem;
    }
    .topbar-avatar { font-size: 1.5rem; }
